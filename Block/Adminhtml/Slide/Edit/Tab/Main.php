<?php
namespace Dotsquare\Banner\Block\Adminhtml\Slide\Edit\Tab;
    ...
    protected function _prepareForm()
    {
		...
		$video_id = $fieldset->addField(
            ...
            [
                ...
                'title' => __('Video ID'),
                'required' => false,
				'note' => 'Applied only if "Image or Video" field is set to "YouTube" or "Vimeo". Enter the video id of your YouTube or Vimeo video (not the full link)',
            ]
        );
